            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-1">
                    <div class="text-block">
                        ...
                        <p class="animated" data-animate="fadeInUp" data-delay=".1">If you are interested in {{$siteName}}.com regional representative program and wish to become our regional representative in your country, please click "Become a Representative" button and send us your username, name and surename, country you are from and contact (email). If we are interested in your offer, we will send you more instructions within few days. To be qualified for {{$siteName}}.com regional representative program you need to have an active deposit of more than Ƀ1.</p>
